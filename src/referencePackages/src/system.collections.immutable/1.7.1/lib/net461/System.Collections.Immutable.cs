...
[assembly: System.Reflection.AssemblyFileVersion("4.700.20.21406")]
[assembly: System.Reflection.AssemblyInformationalVersion("3.1.4+c4164928b270ee2369808ab347d33423ef765216")]
...
{
    public partial interface IImmutableDictionary<TKey, TValue> : Generic.IReadOnlyCollection<Generic.KeyValuePair<TKey, TValue>>, Generic.IEnumerable<Generic.KeyValuePair<TKey, TValue>>, IEnumerable
    {
    ...
    public partial struct ImmutableArray<T> : IEnumerable, IEquatable<ImmutableArray<T>>, IList, ICollection, IStructuralComparable, IStructuralEquatable
    {
        ...
        public sealed partial class Builder : IEnumerable
        {
    ...
    public sealed partial class ImmutableDictionary<TKey, TValue> : Generic.IReadOnlyCollection<Generic.KeyValuePair<TKey, TValue>>, Generic.IEnumerable<Generic.KeyValuePair<TKey, TValue>>, IEnumerable, Generic.ICollection<Generic.KeyValuePair<TKey, TValue>>, IDictionary, ICollection
    {
        ...
        public sealed partial class Builder : Generic.ICollection<Generic.KeyValuePair<TKey, TValue>>, Generic.IEnumerable<Generic.KeyValuePair<TKey, TValue>>, IEnumerable, Generic.IReadOnlyCollection<Generic.KeyValuePair<TKey, TValue>>, IDictionary, ICollection
        {
            public int Count { get { throw null; } }
        ...
        public partial struct Enumerator : Generic.IEnumerator<Generic.KeyValuePair<TKey, TValue>>, IDisposable, IEnumerator
        {
            private object _dummy;
            private int _dummyPrimitive;
    ...
    public sealed partial class ImmutableHashSet<T> : IEnumerable, ICollection
    {
        ...
        public partial struct Enumerator : IDisposable, IEnumerator
        {
            private object _dummy;
            private int _dummyPrimitive;
            public T Current { get { throw null; } }
    ...
    public sealed partial class ImmutableList<T> : IEnumerable, IList, ICollection
    {
        ...
        public sealed partial class Builder : IEnumerable, IList, ICollection
        {
            public int Count { get { throw null; } }
    ...
    public sealed partial class ImmutableSortedDictionary<TKey, TValue> : Generic.IReadOnlyCollection<Generic.KeyValuePair<TKey, TValue>>, Generic.IEnumerable<Generic.KeyValuePair<TKey, TValue>>, IEnumerable, Generic.ICollection<Generic.KeyValuePair<TKey, TValue>>, IDictionary, ICollection
    {
    ...
    public sealed partial class ImmutableSortedSet<T> : IEnumerable, IList, ICollection
    {
        ...
        public sealed partial class Builder : IEnumerable, ICollection
        {
            public int Count { get { throw null; } }
